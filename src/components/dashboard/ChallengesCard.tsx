        ...
        <div className="mt-[11px] flex flex-row items-center justify-between">
          ...
          <div className="mt-[10px] flex flex-row gap-[24px]">
            <div className="flex flex-col">
                <p className="text-[14px] font-medium text-[var(--primary)]">100 km</p>
                <p className="text-[10px] text-[var(--subText)]">Distance</p>
            </div>

            <div className="flex flex-col">
                <p className="text-[14px] font-medium text-[var(--primary)]">08:00 am</p>
                <p className="text-[10px] text-[var(--subText)]">Starting Time</p>
            </div>
          </div>
        </div>
